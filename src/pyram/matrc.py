...
def matrc(
    ...
    ksq: NDArray[np.complex128],
    alpw: NDArray[np.float64],
    alpb: NDArray[np.float64],
    ksqw: NDArray[np.float64],
    ksqb: NDArray[np.complex128],
    rhob: NDArray[np.float64],
    ...
    pd1: NDArray[np.complex128],
    pd2: NDArray[np.complex128],
) -> None:
    """
